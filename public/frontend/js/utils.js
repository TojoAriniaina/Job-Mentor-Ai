...
// Copie HTML formaté + fallback texte brut dans le presse-papier
async function copyRichToClipboard(html, text, btn) {
  try {
    ...
    showToast('Copié (texte brut) !', 'info', 1200);
  }
}
