...
$router->post(  '/api/lettre/analyze',  LettreController::class, 'analyze');
...
$router->post(  '/api/entretien/delete/{id}',    EntretienController::class, 'deleteHistory');
...
$router->post(  '/api/entretien/notes/delete/{id}', EntretienController::class, 'deleteNote');
$router->post(  '/api/entretien/last-answer',    EntretienController::class, 'deleteLastAnswer');
$router->post(  '/api/entretien/reset',          EntretienController::class, 'reset');
...
$router->post(  '/api/oral/delete/{id}', OralController::class, 'delete');
