    ...
    private function mapLegacyAction(string $httpMethod, string $uri, string $action): ?array {
        ...
        $mappings = [
            ...
            'entretien' => [
                ...
                'delete-history'=> ['path' => '/api/entretien/delete/{id}',    'method' => 'POST'],
                'list-notes'    => ['path' => '/api/entretien/notes/list',     'method' => 'GET'],
                'get-note'      => ['path' => '/api/entretien/notes/{id}',     'method' => 'GET'],
                'delete-note'   => ['path' => '/api/entretien/notes/delete/{id}', 'method' => 'POST'],
                'delete'        => ['path' => '/api/entretien/last-answer',    'method' => 'POST'],
                'reset'         => ['path' => '/api/entretien/reset',          'method' => 'POST'],
            ],
            // Oral
            'oral' => [
                'list'   => ['path' => '/api/oral/list',   'method' => 'GET'],
                'get'    => ['path' => '/api/oral/{id}',   'method' => 'GET'],
                'delete' => ['path' => '/api/oral/delete/{id}',  'method' => 'POST'],
            ],
            // User
            'user' => [
